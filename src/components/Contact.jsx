...
const Contact = () => {
	...
	const handleSubmit = (e) => {
		...
		emailjs
			.send(
				...
				{
					from_name: username,
					to_name: "Amrit Singh Sardar",
					reply_to: user_email,
					to_email: "iamamrit1190@gmail.com",
	...
	return (
        ...
        <div className='relative z-0 bg-black w-screen h-auto mt-12'>   
			<div className='text-white contact overflow-hidden pt-12 mt-8 ' id='contact'>
